...
@implementation LemonBestView{
    NSMutableArray<NSMutableArray<LemonBestItem *> *> *actionItems;
    UIView *_maskView;
    UIView *_contentView;
...
- (void)addAction: (LemonBestItem *)action groupIndex: (NSInteger)index{
    [self->actionItems[index] addObject: action];
}

- (void)insertAction: (LemonBestItem *)action groupIndex: (NSInteger)index location: (NSInteger)location{
